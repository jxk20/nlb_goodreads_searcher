...
nlb.prototype.Search = function (params) {
  return new Promise((resolve, reject) => {
    ...
    soap.createClient(url, {}, (err, client) => {
      client.CatalogueService.BasicHttpBinding_ICatalogueService.Search(
        searchArgs,
        (err, res) => {
          if (err) {
            reject(err);
...
nlb.prototype.GetTitleDetails = function (params) {
  ...
  return new Promise((resolve, reject) => {
    ...
    soap.createClient(url, {}, (err, client) => {
      client.CatalogueService.BasicHttpBinding_ICatalogueService.GetTitleDetails(
        searchArgs,
        (err, res) => {
          if (err) {
            console.log(err);
...
nlb.prototype.GetAvailabilityInfo = function (params) {
  ...
  return new Promise((resolve, reject) => {
    ...
    soap.createClient(url, {}, (err, client) => {
      client.CatalogueService.BasicHttpBinding_ICatalogueService.GetAvailabilityInfo(
        searchArgs,
        (err, res) => {
          if (err) {
            console.log(err);
